    ...
    <div class="index_contain">
      <div class="index_contain_left">
        ...
        <div class="index_contain_left_contain">
          <div class="iclc_btn">
            <div class="iclc_btn_color" :style="'left:' + (paperType ? 'calc(50% - 9.25px);' : '0;')"></div>
            <div class="iclc_btn_item" :style="paperType == 0 ? 'color:#fff' : ''" @click="changePaperType(0)">模型选择</div>
            <div class="iclc_btn_item" :style="paperType == 1 ? 'color:#fff' : ''" @click="changePaperType(1)">prompt</div>
          </div>
          ...
          <div class="iclc_file">
            <div class="iclc_file_btn" @click="upload">文件上传</div>
            <el-input class="iclc_file_input" v-model="link" placeholder="论文链接输入框"></el-input>
          </div>
          <div class="iclc_submit" @click="submit">提交</div>
        </div>
      </div>
